...
export const getSubcontractors = async () => {
  const response = await axiosClient.get("/subcontractors");
  return response.data;
};

export const createSubcontractor = async (payload) => {
  const response = await axiosClient.post("/subcontractors", payload);
  return response.data;
};
